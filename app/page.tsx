  ...
  return (
    <main>
      ...
      <p className="muted">
        ...
        is set and an AI bot fetches it, you&apos;ll see a <code>doc_view</code> event
        land in PostHog within seconds — with{' '}
        <code>is_ai_bot: true</code>, the agent&apos;s UA, the path, and a
        stable anonymous distinct id.
      </p>
