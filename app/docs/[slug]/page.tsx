...
curl -A "ClaudeBot/1.0" /docs/${slug}`}</code>
      ...
      <p>
        ...
        <code>Content-Type: text/markdown</code>,{' '}
        <code>Content-Signal</code>, and <code>x-markdown-tokens</code> headers.
        A <code>doc_view</code> event is captured in PostHog with{' '}
        <code>source</code> = <code>md-suffix</code>, <code>accept-header</code>
        , or <code>ua-rewrite</code> depending on how the agent arrived.
      </p>
